  ...
  <aside class="w-64 bg-white shadow-lg">
    ...
    <nav class="mt-6">
      <RouterLink
        ...
        :class="{
          'bg-blue-50 border-l-4 border-blue-600 text-gray-700': $route.name === 'admin.dashboard'
        }"
      >
      ...
      <RouterLink
        ...
        class="flex items-center px-6 py-3 text-gray-600 hover:bg-gray-50 hover:border-l-4 hover:border-gray-200"
        :class="{
          'bg-blue-50 border-l-4 border-blue-600 text-gray-700': $route.name === 'admin.ticket'
        }"
      >
