      ...
      <div class="p-6 border-t border-gray-100">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <div>
            ...
            <select
              v-model="form.status"
              class="w-full px-4 py-2 border border-gray-200 text-gray-500 rounded-lg text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
            >
