...
// implement effect on filters use debounce
watch(
  filters,
  debounce(async () => {
...
<template>
  ...
  >
    ...
    <button class="flex items-center justify-center" onclick="this.parentElement.remove()">
          ...
          <div class="flex-1">
            ...
            <div class="mt-4 flex items-center space-x-4">
              ...
              <div class="flex items-center text-sm text-gray-500">
                ...
                <span
                  >Terakhir diupdate
                  {{ DateTime.fromISO(ticket.updated_at).setLocale('id').toRelative() }}</span
                >
              </div>
            </div>
          </div>
