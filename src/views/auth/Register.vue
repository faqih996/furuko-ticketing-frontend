...
// create form ref with registration field
const form = ref({
  name: '',
  email: '',
  password: ''
...
<template>
    ...
    <div>
      ...
      <div class="mt-1 relative">
        <input
          ...
          id="name"
          name="name"
          class="w-full px-4 py-2 text-gray-500 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
  ...
  <div class="mt-6 text-center">
    <p class="text-sm text-gray-600">
      Sudah punya akun?
      <RouterLink :to="{ name: 'login' }" class="font-medium text-blue-600 hover:text-blue-800"
